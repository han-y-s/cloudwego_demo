module github.com/han-y-s/kitex_demo
...
require (
	...
	github.com/kitex-contrib/config-consul v0.0.0-00010101000000-000000000000
...
replace github.com/kitex-contrib/config-consul => /Users/bytedance/go/src/pku/openSource/config-consul
